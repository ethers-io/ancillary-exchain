...
describe("Test BscscanProvider", function () {
    ...
    it("Sends a transaction", function () {
        return __awaiter(this, void 0, void 0, function () {
            var secret, wallet, tx, receipt;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.timeout(60000);
                        secret = JSON.parse(fs_1["default"].readFileSync(path_1.resolve(__dirname, "../env.json")).toString()).secret;
                        wallet = new ethers_1.ethers.Wallet(ethers_1.ethers.utils.id(secret), provider);
                        console.log(wallet);
